...
/obj/effect/proc_holder/spell/targeted/projectile/dumbfire/rust_wave
	...
	desc = "Направляет энергию в вашу перчатку, высвобождение ее создает волну ржавчины на своем пути."
...
/obj/effect/proc_holder/spell/targeted/fire_sworn
	name = "Клятва огня"
	desc = "На минуту высоздадите вокруг себя огненное кольцо."
	invocation = "FL'MS"
	invocation_type = INVOCATION_WHISPER
	school = SCHOOL_FORBIDDEN
	clothes_req = FALSE
...
/obj/effect/proc_holder/spell/targeted/fiery_rebirth
	...
	desc = "Опустошает здоровья близлежащих живых людей, охваченных пламенем. Он исцеляет 10 от каждого типа повреждений на человека. Если цель находится в критическом состоянии, это высасывает из нее последние жизненные силы, убивая ее."
...
/obj/effect/proc_holder/spell/pointed/void_blink
	name = "Фаза Пустоты"
	desc = "Вы можете телепортироваться, создаст пузырь урона 3x3 вокруг указанного вами пункта назначения и вашего текущего местоположения. Он имеет минимальный диапазон из 3 плиток и максимальный диапазон из 9 плиток."
	invocation_type = INVOCATION_WHISPER
	school = SCHOOL_FORBIDDEN
...
/obj/effect/proc_holder/spell/targeted/void_pull
	name = "Пустотная Тяга"
	desc = "Вызовите пустоту, это притянет всех ближайших людей ближе к вам, оглушит людей, которые уже окружают вас. Если они стоят в диапазоне 4 плиток или ближе, они также сбиваются с ног и применяется микро-оглушение.."
	invocation_type = INVOCATION_WHISPER
